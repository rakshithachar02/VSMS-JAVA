	...
	<div class="container">
    	...
    	<form action="register" method="POST">
        	...
        	<div class="d-flex justify-content-end mt-3">
            	<button type="submit" class="btn btn-success" name="addServiceRequest" value="addServiceRequest">Save Request</button>
            	<a href="ServiceRequests.jsp" class="btn btn-secondary  ms-2" >Close</a>
        	</div>
    	</form>
	</div>
