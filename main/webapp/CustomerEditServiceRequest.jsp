...
<html>
	<head>
    	...
    	<style>
    		body {
    			background: linear-gradient(to right, rgb(45, 71, 86, 1), rgb(46, 86, 109, 1), rgb(45, 71, 86, 1));
    		}
        	.container {
            	max-width: 1000px;
            	margin-top: 40px;
	...
	<div class="container">
    	...
    	<form action="register?srid=<%=sr.getId()%>" method="POST">
        	...
        	<div class="d-flex justify-content-end mt-3">
            	<button type="submit" class="btn btn-success" name="addServiceRequest" value="aServiceRequest">Save Request</button>
            	<a href="CustomerIndex.jsp" class="btn btn-secondary  ms-2" >Cancel</a>
        	</div>
    	</form>
	</div>
