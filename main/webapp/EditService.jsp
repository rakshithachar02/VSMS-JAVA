...
<body>
	<% 
        ...
        Service s = v.getServiceInfo(sid);%>
    <div class="d-flex">
        <%@ include file="AdminSideNav.jsp" %>
        <div class="main-content">
            <%@ include file="AdminHeader.jsp" %>
            <div class="container1">
            	<div class="header"><h3>Update Service</h3></div>
            	
                <div class="form-container p-4">
                    <form method="post" action="register?sid=<%=s.getId()%>">
                        <div class="mb-3">
                            <label for="sname" class="form-label">Service Name</label>
                            <textarea class="form-control" id="sname" name="sname" required><%=s.getService()%></textarea>
                        </div>
                        <div class="mb-3">
                            <label for="description" class="form-label">Service Name</label>
                            <textarea class="form-control" id="description" name="description" required><%=s.getDescription()%></textarea>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary" name="editService" value="editService">Save</button>
