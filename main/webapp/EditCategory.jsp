...
<body>
	<% 
        ...
        Category c = v.getCategoryInfo(cid);%>
    <div class="d-flex">
        <%@ include file="AdminSideNav.jsp" %>
        <div class="main-content">
            <%@ include file="AdminHeader.jsp" %>
            <div class="container1">
            	<div class="header"><h3>Update Category</h3></div>
            	
                <div class="form-container p-4">
                    <form method="post" action="register?cid=<%=c.getId()%>">
                        <div class="mb-3">
                            <label for="cname" class="form-label">Category Name</label>
                            <textarea class="form-control" id="cname" name="cname" required><%=c.getCategory()%></textarea>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary" name="editCategory" value="editCategory">Save</button>
