    ...
    <div class="d-flex">
        ...
        <div class="main-content">
            ...
            <div class="container1">
            	<div class="header"><h3>Create New Category</h3></div>
            	
                <div class="form-container p-4">
                    <form method="post" action="register">
                        <div class="mb-3">
                            <label for="cname" class="form-label">Category Name</label>
                            <textarea class="form-control" id="cname" name="cname" required></textarea>
                        </div>
                        ...
                        <button type="submit" class="btn btn-primary" name="addCategory" value="addCategory">Save</button>
