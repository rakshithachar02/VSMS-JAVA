...
<html>
	...
	<div class="container">
    	<h3 class="mb-2">Create Service Request</h3>
    	<hr>
    	...
    	<form action="register" method="POST">
        	<div class="row g-2">
            	...
            	<div class="col-md-6">
                	...
                	<input type="text" id="regNo" name="regNo" class="form-control"  pattern="[A-Z]{2}-[0-9]{2}-[A-Z]{2}-[0-9]{4}" title="Ex: KA-09-HK-5432" required>
            	</div>
            	<div class="col-md-6">
                	<label for="contact" class="form-label">Owner Contact #</label>
                	<input type="text" id="contact" name="contact" class="form-control"  pattern="[6-9]{1}[0-9]{9}" title="Exact 10-digit starts with (6-9)" required>
            	</div>
            	<div class="col-md-6">
            	...
            	<div class="col-md-6">
                	...
                	<input type="email" id="email" name="email" class="form-control"  pattern="[a-z0-9._%+\-]+@gmail.com$" title="ends with @gmail.com" required>
            	</div>
            	<div class="col-md-6">
            	...
            	<div class="col-md-6" id="pickupAddressContainer">
                	...
                	<textarea id="pickAddress" name="pickAddress" class="form-control" ></textarea>
            	</div>
        	</div>
        	
        	
        	<div class="d-flex justify-content-end mt-3">
            	<button type="submit" class="btn btn-success" name="addCustomerServiceRequest" value="addCustomerServiceRequest">Save Request</button>
            	<a href="CustomerIndex.jsp" class="btn btn-secondary  ms-2" >Close</a>
        	</div>
    	</form>
	</div>
