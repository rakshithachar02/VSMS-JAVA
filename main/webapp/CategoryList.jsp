        ...
        <div class="main-content">
            ...
            <div class="container1">
                ...
                <div class="d-flex justify-content-between align-items-center header1">
                    ...
                    <a href="CreateCategory.jsp" class="btn btn-primary d-flex align-items-center">
                        <i class="fas fa-plus me-2"></i> Create New
                    </a>
                </div>
                <% if (request.getAttribute("status") != null) {%>   
        			<h4 class="bg-danger text-light mb-3 p-2 "><%= request.getAttribute("status")%></h4>
        		<%}%>
        		
                <div class="table-responsive mt-1 p-3">
                	<div class="d-flex justify-content-between">
                		<p>Show <span >10 </span> entries
                		<div>Search: <input type="search" id="categorySearch" placeholder="category name"> </div>
                	</div>
                    ...
                    <table class="table">
                        ...
                        <tbody id="categoryTable">
                        	<% Vehicle v = new Vehicle(session);
                        	   ArrayList<Category> cList = v.getCategoryList();
                            ...
                            <tr>
                                <td><%= num %></td>
                                <td><%= c.getDate_created() %></td>
                                <td class="category-name"><%= c.getCategory() %></td>
                                <td>
                                <% if(c.getStatus() == 1) { %>
