...
<head>
    ...
    <title>Edit Mechanic List</title>
    <!-- Bootstrap CSS -->
...
<body>
	<% 
        ...
        Mechanic m = v.getMechanicInfo(mid);%>
    <div class="d-flex">
        <%@ include file="AdminSideNav.jsp" %>
        <div class="main-content">
            <%@ include file="AdminHeader.jsp" %>
            <div class="container1">
            	<div class="header"><h3>Update Mechanic</h3></div>
            	
                <div class="form-container p-4">
                    <form method="post" action="register?mid=<%=m.getId()%>">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="contact" name="contact" value="<%=m.getContact()%>" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <button type="submit" class="btn btn-primary" name="editMechanic" value="editMechanic">Save</button>
